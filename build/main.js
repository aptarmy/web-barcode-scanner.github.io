...
var BarcodeReaderComponent = (function () {
    ...
    BarcodeReaderComponent.prototype.quaggaOnProcessed = function (result) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_quagga___default.a.canvas.ctx.overlay.canvas.width = parseFloat(getComputedStyle(document.querySelector('#recordScreen video'), null).getPropertyValue('width'));
        __WEBPACK_IMPORTED_MODULE_1_quagga___default.a.canvas.ctx.overlay.canvas.height = parseFloat(getComputedStyle(document.querySelector('#recordScreen video'), null).getPropertyValue('height'));
    ...
    BarcodeReaderComponent.prototype.quaggaOnDetected = function (data) {
        ...
        if (data && data.codeResult && data.codeResult.code && data.codeResult.code !== this.currentDecodedCode) {
            this.currentDecodedCode = data.codeResult.code;
